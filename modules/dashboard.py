...
def render_main_table(df_reorder: pd.DataFrame) -> None:
    ...
    st.markdown('### <span class="material-symbols-rounded" style="vertical-align: bottom;">table_chart</span> Tabla de Análisis Completo', unsafe_allow_html=True)
...
def render_charts(df_reorder: pd.DataFrame) -> None:
    ...
    st.markdown('### <span class="material-symbols-rounded" style="vertical-align: bottom;">bar_chart</span> Visualizaciones', unsafe_allow_html=True)
